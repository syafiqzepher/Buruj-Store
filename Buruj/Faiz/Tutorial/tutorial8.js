...
export default class Tutorial8Screen extends Component {
        ...
        <View style={styles.screen}>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.titleText}>SET YOUR COUNTRY</Text>
            </View>

            <View style={styles.videoContainer}>
              <Video
                ref={(ref) => {this.video = ref}}     
                source={{uri: 'https://gdurl.com/KqbG'}}
                ...
                onEnd={this.onEnd}
                poster="https://gdurl.com/6yvF" // uri to an image to display until the video plays
