...
export default class Tutorial3Screen extends Component {
        ...
        <View style={styles.screen}>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.titleText}>SET AZAN ALARM</Text>
            </View>

            <View style={styles.videoContainer}>
              <Video
                ref={(ref) => {this.video = ref}}     
                source={{uri: 'https://gdurl.com/tYX1'}}
                ...
                onEnd={this.onEnd}
                poster="https://gdurl.com/KCelx" // uri to an image to display until the video plays
