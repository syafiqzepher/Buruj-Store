...
export default class TutorialScreen2 extends Component {
        ...
        <View style={styles.screen}>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.titleText}>QIBLA CALIBRATION</Text>
            </View>

            <View style={styles.videoContainer}>
              <Video
                ref={(ref) => {this.video = ref}}     
                source={{uri: 'https://gdurl.com/vfLr'}}
                ...
                poster="https://gdurl.com/0zh7" // uri to an image to display until the video plays
          ...
          <View style={styles.container2}>
            ...
            onPress={() => this.props.navigation.replace('Tutorial')}>
              <Text style={styles.buttonText}>Buruj Watches Features</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.buttonContainer}
            onPress={() => this.props.navigation.replace('Tutorial3')}>
              <Text style={styles.buttonText}>Set Azan Alarm</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.buttonContainer}
