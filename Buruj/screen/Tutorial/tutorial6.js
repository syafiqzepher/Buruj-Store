...
export default class Tutorial6Screen extends Component {
        ...
        <View style={styles.screen}>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.titleText}>DST SELECT</Text>
            </View>

            <View style={styles.videoContainer}>
              <Video
                ref={(ref) => {this.video = ref}}     
                source={{uri: 'https://gdurl.com/5q37'}}
                ...
                onEnd={this.onEnd}
                poster="https://gdurl.com/2-lm" // uri to an image to display until the video plays
