...
export default class Tutorial7Screen extends Component {
        ...
        <View style={styles.screen}>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.titleText}>AZAN SAFETY</Text>
            </View>

            <View style={styles.videoContainer}>
              <Video
                ref={(ref) => {this.video = ref}}     
                source={{uri: 'https://gdurl.com/gYcY'}}
                ...
                onEnd={this.onEnd}
                poster="https://gdurl.com/eLmh" // uri to an image to display until the video plays
